...
async def solve_layered(
    ...
    if request.current_state_overrides:
        current_state = {**current_state, **request.current_state_overrides}
    ...
    solve_req = SolveRequest(
        ...
        overrides={
            ...
            "activity_scope_node_ids": request.activity_scope_node_ids,
            "current_state_overrides": request.current_state_overrides,
            "direct_goal_facts": [
    ...
    try:
        ...
        plan_id = await save_candidate_plan(
            ...
            version=1,
            parent_plan_id=None,
            replan_reason="layered_initial",
        )
        await session.flush()

        sched_result = await solve_schedule(plan_id, session, objectives=objectives)
        ...
        await compute_step_role_diff(plan_id, None, session)
